...
class Siegel(models.Model):
    
    bezeichnung = models.CharField(db_column='Bezeichnung', blank=True, null=True, max_length=80)  # Field name made lowercase. This field type is a guess.
    tier = models.CharField(db_column='Tier', blank=True, null=True, max_length=40)  # Field name made lowercase. This field type is a guess.
    haltung_auslauf = models.CharField(db_column='Haltung_Auslauf', blank=True, null=True, max_length=800)  # Field name made lowercase. This field type is a guess.
